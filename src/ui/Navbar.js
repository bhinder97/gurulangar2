...
function Navbar(props) {
  ...
  const navItems = [
    ...
    { heading: "About Us", page: "/About", icon: <InfoIcon className="icons" /> },
    { heading: "Our Work", page: "/Products", icon: <StoreIcon className="icons" /> }, //'our work' will be in the products.js file
    { heading: "Contact", page: "/Contact", icon: <ContactsIcon className="icons" /> },
  ];
